...
const DialogDescription = React.forwardRef<
  ...
  React.ComponentProps<typeof ReactDialog.Description>
...
// const DialogTitle = React.forwardRef<HTMLHeadingElement, React.ComponentProps<typeof ReactDialog.Title>>(
//   function DialogTitle({ className, children, ...props }, ref) {
//     return (
//       <ReactDialog.Title
//         className={cn(
