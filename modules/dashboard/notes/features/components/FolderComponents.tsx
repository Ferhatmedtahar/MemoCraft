...
import { deleteFolder, updateFolder } from "../../data/folderActions";
      ...
      <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <Dialog.Content className="sm:max-w-[425px] mx-2 sm:mx-0">
          <Dialog.Header>
            ...
            <Dialog.Description>
              Are you sure you want to delete this folder? All notes in this
...
//           {isOver && (
//             <div className="absolute inset-0 rounded-lg border-2 border-dashed border-white/50 bg-white/10 flex items-center justify-center">
//               <span className="text-white font-medium">Drop note here</span>
//             </div>
//           )}
//         </Card>
